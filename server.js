...
const ownerID = '716787617563148338'
  ...
  let statuses =  ['باپیرەگەورەی دیڤلۆپەرەکان','🅱🅷 | 🆄🅿','XOSHM|UP','YASHEXAKAM|UP'] ////←←←←لێرە شتەکان بنوسە
...
message.channel.send ("ئیستا ئەکوامان لەخەت نیە لەچاتی تایبەت نامەم بۆبنێرە جوابت ئەیەمەوە کەهاتمە خەت")
